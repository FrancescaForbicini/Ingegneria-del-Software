...
public class AssaignWhiteMarble extends LeaderCardStrategy{
    ...
    public AssaignWhiteMarble(int victoryPoints, ResourceType resourceType, Collection<Requirement> requirement) {
