...
public class AdditionalDepot extends LeaderCardStrategy{
    // TODO private WarehouseDepot additionalDepot;
    /**
     ...
     */
    public AdditionalDepot(int victoryPoints, ResourceType resourceType, Collection<Requirement> requirement)
    {
    ...
    //TODO public WarehouseDepot getAdditionalDepot()
}
